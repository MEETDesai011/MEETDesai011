...
meet = {
    ...
    "education"  : "Diploma in Computer Engineering @ SVKM's SBMP",
    "building"   : ["AI tools", "Web apps", "Shopify solutions"],
...
- 🥇 Competing in **Agents Assemble: Healthcare AI Endgame** (~$25K prize pool)
- 🎯 Building **Clinical Handoff Intelligence MCP Server** — real-world healthcare problem
- 🏅 Chrome Extension AI Hackathon — placed 641st globally (solo, first attempt)
- 📜 **CodSoft Python Internship** certified
---
 
## 💡 Currently Exploring
 
```
🔸 MCP (Model Context Protocol) servers with FastMCP
🔸 HAPI FHIR — healthcare data standards
🔸 Agentic AI workflows with Gemini 1.5 Flash
🔸 Open source contributions (Python + JS ecosystem)
🔸 Shopify web design for D2C brands
```
...
<div align="center">
Got a collab idea, freelance project, or just want to talk code?
 
[![Email](https://img.shields.io/badge/Drop_a_mail-meetdesai0311%40gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:meetdesai0311@gmail.com)
[![LinkedIn](https://img.shields.io/badge/Connect_on-LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/meetdesai011)
...
![Profile Views](https://komarev.com/ghpvc/?username=MEETDesai011&color=blueviolet&style=flat-square&label=Profile+Views)
